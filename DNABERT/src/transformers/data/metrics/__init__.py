...
if _has_sklearn:
    ...
    def glue_compute_metrics(task_name, preds, labels, probs=None):
        ...
        if task_name == "cola":
            ...
            return {"acc": simple_accuracy(preds, labels)}
        elif task_name == "dnaspecies":
            return acc_and_f1(preds, labels)
        elif task_name == "dnagenus":
            return acc_and_f1(preds, labels)
        elif task_name == "dnafamily":
            return acc_and_f1(preds, labels)
        elif task_name == "dnaorder":
            return acc_and_f1(preds, labels)
        elif task_name == "dnaclass":
            return acc_and_f1(preds, labels)
        elif task_name == "dnaphylum":
            return acc_and_f1(preds, labels) 
        elif task_name == "dnavirus":
            return acc_and_f1(preds, labels)
        else:
